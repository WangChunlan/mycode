...
public class CallActionAspect {
    ...
    @Around(value = "execution(public * com.smartpos.controller.online.*.*(..)) && @annotation(apiRestAction) || execution(public * com.smartpos.controller.o2o.*.*(..)) && @annotation(apiRestAction) || execution(public * com.smartpos.controller.hzg.*.*(..)) && @annotation(apiRestAction))")
    ...
    @Around(value = "execution(public * com.smartpos.controller.online.*.*(..)) && @annotation(resultJSONAction)")
