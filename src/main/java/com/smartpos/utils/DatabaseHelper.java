...
import com.smartpos.mapper.UniversalMapper;
...
public class DatabaseHelper {
    ...
    static {
        ApplicationHandler.registerBeanUtilsConverts();
    }
    ...
    public static List<Map<String, Object>> executeQueryUnderscore(Map<String, Object> parameters) {
        return obtainUniversalMapper().executeQueryUnderscore(parameters);
    }
}
